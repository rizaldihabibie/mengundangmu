...
<body>
	...
	<section id="home">
		...
		<div id="main-carousel" class="carousel slide" data-ride="carousel"> 
			...
			<div class="item" style="background-image: url(<?php echo base_url(); ?>assets/template/images/slider/slide1.jpg)"> 
				<div class="carousel-caption"> 
					<div> 
			...
			<div class="row">
				<div class="col-sm-4 col-md-4">
						<div class="single-blog">
							<img src="<?php echo base_url(); ?>assets/template/images/our-team/member1.jpg" alt="team member" />
					...
					<div class="col-sm-4 col-md-4">
						<div class="single-blog1">
							<img src="<?php echo base_url(); ?>assets/template/images/our-team/member2.jpg" alt="team member" />
		...
		<div class="container">
			<div class="event">
				<div class="row text-center">
					<div class="col-sm-8 col-sm-offset-2">
						<h2 class="title-one"><span style="color: #BC82FD;font-family: Petit Formal Script; font-size: 40pt;">Event Details</span><br><img src="<?php echo base_url(); ?>assets/countdown/header3.png" class="img-responsive" alt=""></h2>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
							<center><img src="<?php echo base_url(); ?>assets/countdown/logotgh2.png" class="img-responsive faa-flash animated faa-slow " alt="team member" width="500" height="700"></center>
						</div>
						<div class="col-sm-4">
							<div class="single-service">
								<div class="row text-center">
	...
	<section id="family">
				<div class="container">
					<div class="family">
						<div class="row text-center">
							<div class="col-sm-8 col-sm-offset-2">
								<h2 class="title-one"><span style="color: #BC82FD;font-family: Petit Formal Script; font-size: 40pt;">Family</span><br><img src="<?php echo base_url(); ?>assets/countdown/header3.png" class="img-responsive" alt=""></h2>
							...
							<div class="col-sm-12">
								...
								<div class="col-sm-4">
									<!-- <div class="single-service"> -->
										<div class="row text-center">
											...
											<center><span style="font-family: Comming Soon; font-size: 14pt; color: #43484E;">Bapak Fulan Bin Fulan
												<br>Ibu Fulanah Binti Fulanah
											<br>Jl. Parang Kembang 1 No.18 Semarang</span></center><hr>
										</div>
									<!-- </div> -->
								</div>
								<div class="col-sm-4">
								...
								<div class="col-sm-4">
									<!-- <div class="single-service"> -->
										<div class="row text-center">
											<h2><span style="font-family: Dancing Script; color: #333;">Keluarga :</span></h2><hr>
											<center><span style="font-family: Alex Brush Soon; font-size: 14pt; color: #43484E;">Bapak Fulan Bin Fulan
												<br>Ibu Fulanah Binti Fulanah
			...
			<section id="clients" class="parallax-section">
						<div class="container">
							<div class="clients-wrapper">
								<div class="row text-center">
									<div class="col-sm-8 col-sm-offset-2">
									<h2 class="title-one"><span style="color: #BC82FD;font-family: Petit Formal Script; font-size: 40pt; text-shadow: 2px 3px #fff;">Guest Book</span><br><img src="<?php echo base_url(); ?>assets/countdown/header3.png" class="img-responsive" alt=""></h2>
		...
		<section id="portfolio">
				<div class="container">
					<div class="row text-center">
						<div class="col-sm-8 col-sm-offset-2">
						<h2 class="title-one"><span style="color: #BC82FD;font-family: Petit Formal Script; font-size: 40pt;">Gallery</span><br><img src="<?php echo base_url(); ?>assets/countdown/header3.png" class="img-responsive" alt=""></h2>
						</div>
					</div>
					<ul class="portfolio-filter text-center">
						...
						<div class="portfolio-items">
							...
							<div class="col-sm-3 col-xs-12 portfolio-item proposal">
								<div class="view efffect">
									<div class="portfolio-image">
										<img src="<?php echo base_url(); ?>assets/template/images/portfolio/4.jpg" alt="">
									</div>
									<div class="mask text-center">
										<h3></h3>
										<h4></h4>
										<a href="<?php echo base_url(); ?>assets/template/images/portfolio/4.jpg" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
									</div>
								</div>
							</div>
							<div class="col-sm-3 col-xs-12 portfolio-item prewedding">
								<div class="view efffect">
									<div class="portfolio-image">
										<img src="<?php echo base_url(); ?>assets/template/images/portfolio/5.jpg" alt="">
									</div> <div class="mask text-center">
									<h3></h3>
									<h4></h4>
									<a href="<?php echo base_url(); ?>assets/template/images/portfolio/5.jpg" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3 col-xs-12 portfolio-item proposal">
							<div class="view efffect">
								<div class="portfolio-image">
									<img src="<?php echo base_url(); ?>assets/template/images/portfolio/6.jpg" alt="">
								</div>
								<div class="mask text-center">
									<h3></h3>
									<h4></h4>
									<a href="<?php echo base_url(); ?>assets/template/images/portfolio/6.jpg" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3 col-xs-12 portfolio-item prewedding">
							<div class="view efffect">
								<div class="portfolio-image">
									<img src="<?php echo base_url(); ?>assets/template/images/portfolio/7.jpg" alt="">
								</div>
								<div class="mask text-center">
									<h3></h3>
									<h4></h4>
									<a href="<?php echo base_url(); ?>assets/template/images/portfolio/7.jpg" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3 col-xs-12 portfolio-item proposal">
							<div class="view efffect">
								<div class="portfolio-image">
								<img src="<?php echo base_url(); ?>assets/template/images/portfolio/8.jpg" alt=""></div>
								<div class="mask text-center">
									<h3></h3>
									<h4></h4>
									<a href="<?php echo base_url(); ?>assets/template/images/portfolio/8.jpg" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3 col-xs-12 portfolio-item prewedding">
							<div class="view efffect">
								<div class="portfolio-image">
									<img src="<?php echo base_url(); ?>assets/template/images/portfolio/9.jpg" alt="">
								</div>
								<div class="mask text-center">
									<h3></h3>
									<h4></h4>
									<a href="<?php echo base_url(); ?>assets/template/images/portfolio/9.jpg" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3 col-xs-12 portfolio-item proposal">
							<div class="view efffect">
								<div class="portfolio-image">
								<img src="<?php echo base_url(); ?>assets/template/images/portfolio/10.jpg" alt=""></div>
								<div class="mask text-center">
									<h3></h3>
									<h4></h4>
						...
						<div class="col-sm-3 col-xs-12 portfolio-item prewedding">
							<div class="view efffect">
								<div class="portfolio-image">
								<img src="<?php echo base_url(); ?>assets/template/images/portfolio/11.jpg" alt=""></div>
								<div class="mask text-center">
									<h3></h3>
									<h4></h4>
						...
						<div class="col-sm-3 col-xs-12 portfolio-item proposal">
							<div class="view efffect">
								<div class="portfolio-image">
								<img src="<?php echo base_url(); ?>assets/template/images/portfolio/12.jpg" alt=""></div>
								<div class="mask text-center">
									<h3></h3>
									<h4></h4>
